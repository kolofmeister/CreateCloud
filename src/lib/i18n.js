...
const translations = {
    en: {
        ...
        'settings.muapiKeyLabel': 'fal.ai API Key',
        'settings.keyPlaceholder': 'Enter your fal.ai API key...',
        'settings.keyNote': 'Your API key is stored locally and never sent anywhere except queue.fal.run.',
        'settings.invalidKey': 'Please enter a valid API key.',

        // Auth Modal
        'auth.title': 'fal.ai API Key Required',
        'auth.subtitle': 'Create a fal.ai API key, then paste the key value here to start creating.',
        'auth.keyLabel': 'fal.ai API Key',
        'auth.keyPlaceholder': 'Paste your fal.ai key here...',
        'auth.keyNote': 'Get your key at fal.ai/dashboard/keys',
        'auth.initBtn': 'Initialize Studio',
        'auth.createKey': 'Get a fal.ai API key →',
    ...
    zh: {
        ...
        'settings.muapiKeyLabel': 'fal.ai API 密钥',
        'settings.keyPlaceholder': '输入您的 fal.ai API 密钥...',
        'settings.keyNote': '您的 API 密钥仅存储在本地，除 queue.fal.run 外不会发送到任何地方。',
        'settings.invalidKey': '请输入有效的 API 密钥。',

        // Auth Modal
        'auth.title': '需要 fal.ai API 密钥',
        'auth.subtitle': '创建一个 fal.ai API 密钥，然后将密钥值粘贴到这里开始创建。',
        'auth.keyLabel': 'fal.ai API 密钥',
        'auth.keyPlaceholder': '粘贴您的 fal.ai 密钥...',
        'auth.keyNote': '在 fal.ai/dashboard/keys 获取您的密钥',
        'auth.initBtn': '初始化工作室',
        'auth.createKey': '获取 fal.ai API 密钥 →',
